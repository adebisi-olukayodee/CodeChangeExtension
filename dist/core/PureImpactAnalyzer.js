...
import { createEmptyReport } from '../types/ImpactReport';
...
export async function analyzeImpact(params, debugLog) {
 ...
 */
export async function analyzeImpactWithDiff(params, debugLog) {
 ...
 */
export async function analyzeImpactEnhanced(params, debugLog) {
    ...
    return EnhancedReportFormatter.format(path.join(params.projectRoot, params.file), result.snapshotDiff, result.report, params.projectRoot);
}
/**
